...
import com.olp.course_mgmt.to.CreateCourceRespTo;
...
public class CourseRestController {
	...
	// TO SAVE NEW COURSE
	@PostMapping("/save")
	public CreateCourceRespTo createCourse(@RequestBody Course course) {
		CreateCourceRespTo createCourceResp = new CreateCourceRespTo();
		try {
